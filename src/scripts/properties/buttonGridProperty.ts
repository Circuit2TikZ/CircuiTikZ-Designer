...
export class ButtonGridProperty extends EditableProperty<never>{
	...
	public constructor(buttonsPerRow:1|2|3|4|6|12, labels:[string,string|[string,string]][], callbacks:((ev:Event)=>void)[], materialSymbols=false){
		super()
	...
	public eq(first: never, second: never): boolean {return false}
